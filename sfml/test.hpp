...
void test(int questionNumber) {
	...
	sf::Texture chooseAnswerTexture, quitButtonTexture, schoolAccessories1Texture,
	schoolAccessories2Texture, schoolAccessories3Texture, schoolAccessories4Texture, schoolAccessories5Texture,
	schoolAccessories6Texture, schoolAccessories7Texture, schoolAccessories8Texture;
	...
	if (!schoolAccessories1Texture.loadFromFile("images/schoolAccessories1.png")) {
		std::cout << "Texture loading error" << std::endl;
	}

	if (!schoolAccessories2Texture.loadFromFile("images/schoolAccessories2.png")) {
		std::cout << "Texture loading error" << std::endl;
	}

	if (!schoolAccessories3Texture.loadFromFile("images/schoolAccessories3.png")) {
		std::cout << "Texture loading error" << std::endl;
	}

	if (!schoolAccessories4Texture.loadFromFile("images/schoolAccessories4.png")) {
		std::cout << "Texture loading error" << std::endl;
	}

	if (!schoolAccessories5Texture.loadFromFile("images/schoolAccessories5.png")) {
		std::cout << "Texture loading error" << std::endl;
	}

	if (!schoolAccessories6Texture.loadFromFile("images/schoolAccessories6.png")) {
		std::cout << "Texture loading error" << std::endl;
	}

	if (!schoolAccessories7Texture.loadFromFile("images/schoolAccessories7.png")) {
		std::cout << "Texture loading error" << std::endl;
	}

	if (!schoolAccessories8Texture.loadFromFile("images/schoolAccessories8.png")) {
		std::cout << "Texture loading error" << std::endl;
	}

	// creating "constant" sprites for app
	sf::Sprite chooseAnswerSprite, quitButtonSprite, schoolAccessories1Sprite,
	schoolAccessories2Sprite, schoolAccessories3Sprite, schoolAccessories4Sprite, schoolAccessories5Sprite,
	schoolAccessories6Sprite, schoolAccessories7Sprite, schoolAccessories8Sprite;
	...
	schoolAccessories1Sprite.setTexture(schoolAccessories1Texture);
	schoolAccessories1Sprite.setScale(0.40, 0.40);
	schoolAccessories1Sprite.setPosition(575, 25);

	schoolAccessories2Sprite.setTexture(schoolAccessories2Texture);
	schoolAccessories2Sprite.setScale(0.40, 0.40);
	schoolAccessories2Sprite.setPosition(600, 20);

	schoolAccessories3Sprite.setTexture(schoolAccessories3Texture);
	schoolAccessories3Sprite.setScale(0.25, 0.25);
	schoolAccessories3Sprite.setPosition(60, 450);

	schoolAccessories4Sprite.setTexture(schoolAccessories4Texture);
	schoolAccessories4Sprite.setScale(0.40, 0.40);
	schoolAccessories4Sprite.setPosition(580, 160);

	schoolAccessories5Sprite.setTexture(schoolAccessories5Texture);
	schoolAccessories5Sprite.setScale(0.35, 0.35);
	schoolAccessories5Sprite.setPosition(585, 135);

	schoolAccessories6Sprite.setTexture(schoolAccessories6Texture);
	schoolAccessories6Sprite.setScale(1, 1);
	schoolAccessories6Sprite.setPosition(75, 150);

	schoolAccessories7Sprite.setTexture(schoolAccessories7Texture);
	schoolAccessories7Sprite.setScale(0.60, 0.60);
	schoolAccessories7Sprite.setPosition(30, 25);

	schoolAccessories8Sprite.setTexture(schoolAccessories8Texture);
	schoolAccessories8Sprite.setScale(1, 1);
	schoolAccessories8Sprite.setPosition(650, 25);
	...
	if (questionNumber == 1) {
		...
		while (window.isOpen()) {
			...
			window.draw(schoolAccessories1Sprite);
	...
	// if this is the second question 
		...
		while (window.isOpen()) {
			...
			window.draw(schoolAccessories2Sprite);
			window.draw(schoolAccessories3Sprite);
	...
	// if this is the third question 
		...
		while (window.isOpen()) {
			...
			window.draw(schoolAccessories4Sprite);
	...
	// if this is the fourth question 
		...
		while (window.isOpen()) {
			...
			window.draw(schoolAccessories5Sprite);
			window.draw(schoolAccessories6Sprite);
	...
	// if this is the fifth question
		...
		while (window.isOpen()) {
			...
			window.draw(schoolAccessories7Sprite);
			window.draw(schoolAccessories8Sprite);
